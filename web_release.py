...
modules_enabled_by_default = (
    "no"  # Disables all modules so you can only enable what you need
)
module_gdscript_enabled = "yes"
module_text_server_fb_enabled = (
    "yes"  # Fallback text server; less features but works fine for English.
)
module_freetype_enabled = (
    "yes"  # Needed alongside a text server for text to render correctly
)
